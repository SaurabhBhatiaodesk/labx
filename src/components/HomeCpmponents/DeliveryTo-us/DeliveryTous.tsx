              ...
              {/* {[
                ...
                .map((content, index) => (
                  <div className="flex items-start gap-4" key={index}>
                    ...
                    />
                    <div>
                      <p><span>here i want content titles</span>{content}</p>
                    </div>
                  </div>
                ))} */}
              {[
                ...
                .filter((item) => item.content) // Ensure we only map over items with content
                .map((item, index) => (
                  <div className="flex items-start gap-4" key={index}>
                    <Image
                      className="w-[30px] h-[30px]"
                    ...
                    <div>
                      <p>
                        <span className="font-bold pb-[2px] border-b-[#fff563] border-b-[1px] ">{item.title}</span>:
                        {item.content}
                      </p>
                    </div>
                  </div>
