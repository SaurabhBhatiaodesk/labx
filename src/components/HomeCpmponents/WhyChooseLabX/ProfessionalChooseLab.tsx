  ...
  const sectionData = [
    {
      ...
      content:
        "Duration: 5 Days | Price: $1249 (Includes a free toolkit for each student)",
      ...
      Background: "linear-gradient(74deg, #fff563, #000000)", // Converted to HEX
    ...
    },
    {
      ...
      Background: "linear-gradient(74deg, #56c1c1, rgb(0, 0, 0)", // Converted to HEX
    ...
    },
    {
      ...
      Background: "linear-gradient(74deg, #f35520c0, rgb(0, 0, 0)", // Converted to HEX
    ...
    },
    {
      ...
      Background: "linear-gradient(74deg, #d5fd33a1, rgb(0, 0, 0)", // Converted to HEX
