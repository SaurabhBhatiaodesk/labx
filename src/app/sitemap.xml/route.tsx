...
//     const websiteUrl = "https://labxrepair.com.au/";
//     let fetchedUrls: string[] = [];
//     const blogapi = "https://labxbackend.labxrepair.com.au/api/admin/blogs";    
    ...
    try {
        ...
        $("a").each((_, link) => {
            ...
            if (url.trim().length > 0) {
                const fullUrl = url.startsWith("/") ? `${websiteUrl}${url.replace(/^\/+/, "")}` : url;
    ...
    try {
        ...
        if (Array.isArray(blogs)) {
            blogs.forEach((blog: any) => {
                if (blog.pageTitle) {
                    fetchedUrls.add(`${websiteUrl}blogpage/${blog.pageTitle}`);
                }
            });
        }
    } catch (error) {
