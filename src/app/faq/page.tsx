...
const page = () => {
    const faqData = [
        ...
        {
          category: 'Screen Refurbishing FAQs',
          accordionData: [
            {
        ...
        },
        {
          ...
          {
            category: 'Shipping & Returns FAQs',
            accordionData: [
              {
