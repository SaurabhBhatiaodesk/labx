...
console.log("pricingAgreement",pricingAgreement)
    ...
    console.log('repairDetails?.previousRepairAttempts',repairDetails?.previousRepairAttempts)
    return (
      <>
        <section>
    ...
    <>
      ...
      value={repairDetails?.previousRepairAttempts || "No"}  // Default value "No"
        ...
        Yes
                  ...
                  <div className="mt-2">
                    <Textarea
                      ...
                      style={{
                        borderColor: "#ffffff",
                        borderRadius: "0.375rem",
                        fontSize: "0.875rem", // Thin size text area
                        padding: "0.5rem",
                      }}
                      value={repairDetails.previousRepairAttemptsComments}
                      onChange={(e) =>
                        setRepairDetails({
                          ...repairDetails,
                          previousRepairAttemptsComments: e.target.value,
                        })
                      }
                    />
              ...
              <div>
                <h4 className="lg:text-lg text-sm lg:pb-3 pb-[5px]">
                  Want to Jump the Queue for Faster Service at an Additional Cost?*
                </h4>
                <Select
    className="bg-black text-white gauav"
    value={repairDetails.jumpQueueForFasterService || "No"}
    onChange={(e: React.ChangeEvent<HTMLSelectElement>) =>
      setRepairDetails({
        ...repairDetails,
  ...
  {shippingDetails.requireReturnLabel === "Yes" && (
    <>
      ...
      {errors.requireReturnLabel && (
        <p className="text-red-500 text-sm mt-1">{errors.requireReturnLabel}</p>
      )}
    </>
  )}
</div>
 ...
 <div>
  ...
  {shippingDetails.requirePickupLabel === "Yes" && (
    <>
      ...
      {errors.requirePickupLabel && (
        <p className="text-red-500 text-sm mt-1">{errors.requirePickupLabel}</p>
      )}
    </>
  )}
</div>
  ...
  <div className="border-b-[1px] border-[#6161617b] xl:py-3">
          ...
          <div className="my-5">
            ...
            />
            {errors.signature && (
              <p className="text-[red] text-sm mb-0">{errors.signature}</p>
            )}
          </div>
        </div>
        <div className="py-4">
