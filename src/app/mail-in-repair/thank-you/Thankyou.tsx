...
const Thankyou = () => {
    const steps = [
        {
          title: 'Print & Pack',
          content: 'Print the PDF attachment in your email and place it inside the package.',
          subtitle: 'Don’t have a printer?',
          subcontent:"  Please include your Ticket # and contact info so we can look you up upon receiving your package. "
        },
        {
          title: 'Confirmation',
          content: 'You will get an email confirmation when your package has been received. It’s your responsibility to get a quote before mailing your device.',
        },
        {
          title: 'Repair',
          content: 'Your device will be worked on in the order it was received. Queue time is 4-8 weeks for regular service & 1-9 days for expedited. To be added to the Expedited Queue, please mail a check or money order with your package in the amount of $95.',
        },
        {
          title: 'Mail Back',
          content: 'Your device will be mailed back to you once the repair is complete and invoice paid. Tracking number will be emailed to you and will update on your ticket.',
        },
      ];
      ...
      <div className='grid grid-cols-1 lg:grid-cols-4 gap-5 my-4'>
        {steps.map((step, index) => (
          ...
          >
            ...
            {step.subtitle && <p className='text-xl text-[#EDE574]  mb-2'>{step.subtitle}</p>}
