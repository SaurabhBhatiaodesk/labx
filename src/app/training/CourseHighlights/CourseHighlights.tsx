          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:py-6 py-3 items-center">
              ...
              <div className="p-2 lg:p-2 bg-black text-white rounded-md">
                ...
                <p>{` Learn specialized techniques for recovering data from severely damaged or non-functional devices, including water-damaged phones and corrupted storage chips. This module will provide you with expertise in extracting critical data in difficult recovery cases.
`}</p> 

                </ul>
                <div>
          
                  <MainButton MainButton="Learn More"  link="/master-motherboard-repair"/>
                </div>
                <div className="my-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:py-6 py-3 items-center">
              <div className="order-2 lg:order-1 p-2 lg:p-2 bg-black text-white rounded-md">
               ...
               <ul className="space-y-2 pb-5">
                ...
                <p>{`  Learn how to safely disassemble mobile devices and inspect LCD and OLED screens for damage, determining whether a screen is suitable for refurbishing or replacement.
