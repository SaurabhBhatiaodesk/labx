          ...
          <div className="grid lg:grid-cols-[5fr_3fr] items-center pt-3">
            <div className="w-full px-4">
              <div className="text-center lg:text-left">
                ...
                <Image  height="80" width="600"src={UnderLine.src} alt="" className="mb-3 about_line" />
        ...
        <section>
          <div className="bg-black text-white flex flex-col items-center py-2 lg:py-4">
            ...
            <div className="w-full p-6">
              ...
              <Image  height="100" width="400"src={Break.src} alt="" className="pb-3 m-auto" />
        ...
        <div className="max-container">
          <div className="grid xl:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-8 lg:py-5 py-3 items-center">
            <div className="">
              ...
              <Image  height="100" width="400"src={Leap.src} alt="" className="pb-3  about_line" />
      ...
      <div className="about__bg__gradiant "  >
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-4 lg:py-6 py-3 items-center ">
          <div className="max-container text-white text-center rounded-md">
            ...
            <Image  height="100" width="300"src={Hand.src} alt="" className="pb-3 m-auto" />
        ...
        <div className="max-container">
          <div className="grid xl:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-8 lg:py-5 py-3 items-center">
            ...
            <div className="">
              ...
              <Image  height="1000" width="600"src={Leap.src} alt="" className="pb-3  about_line" />
      ...
      <div className="about__bg__gradiant pt-8 " >
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-4 lg:py-6 py-3 items-center ">
          <div className="max-container text-white text-center rounded-md">
            ...
            <Image  height="1000" width="900"src={Service.src} className="pb-3 m-auto" alt="" />
            <p className="">
        ...
        <div className="max-container">
          <div className="grid xl:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-8 lg:py-5 py-3 items-center">
            ...
            <div className="">
              ...
              <Image  height="1000" width="600"src={NeedLine.src} alt="" className="pb-3 about_line" />
      ...
      <section className="mt-5 pt-8 bg_light_black " >
        <div className="max-container">
          <div className="text-center mt-5">
            ...
            <Image  height="1000" width="600" src={New.src} alt="" className="pb-3 m-auto" />
          </div>
